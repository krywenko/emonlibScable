...
class EnergyMonitor
{
  public:
    ...
    void calcVID(unsigned int crossings, unsigned int timeout, double adj);
    void calcVI(unsigned int crossings, unsigned int timeout, double adj);
    double calcIrmsD(unsigned int NUMBER_OF_SAMPLES, double adj);
    double calcIrms(unsigned int NUMBER_OF_SAMPLES, double adj);
    void serialprint();
